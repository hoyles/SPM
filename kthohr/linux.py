...
class Builder():
  ...
  def start(self):     
    ...
    if os.path.exists(lapackFileName + '.7z'):
        ...
        os.system('7za x -bd -y lapack-3.9.0.7z 1> spm_lapack_unzip.log 2>&1') 
    else:
    ...
    if os.path.exists(lapackFileName + '.7z'):
        ...
        os.system('7za x -bd -y mcmc.7z 1> spm_mcmc_unzip.log 2>&1') 
    else:
    ...
    os.system('cmake ' + Globals.cmake_compiler_ + ' .. ')
    os.system('make')
