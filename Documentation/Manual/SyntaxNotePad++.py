...
SYNTAX_OUTFILE.write('            <Keywords name="Delimiters"></Keywords>\n')
SYNTAX_OUTFILE.write('        </KeywordLists>\n')
...
SYNTAX_OUTFILE.write('            <WordsStyle name="DELIMITERS1" fgColor="000000" bgColor="FFFFFF" fontName="no" fontStyle="0" nesting="0" />\n')
