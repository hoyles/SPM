...
\defSub{age\_plus\_group} {Define is the maximum age for the observation is a plus group}
\defType{Switch}
\defDefault{True}
...
\subsubsection[Proportions at age]{\commandlabsubarg{observation}{type}{proportions\_at\_length}}
