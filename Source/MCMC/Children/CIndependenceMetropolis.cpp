...
// Headers
#include "CIndependenceMetropolis.h"
...
// Default Constructor
//**********************************************************************
CIndependenceMetropolis::CIndependenceMetropolis() {
  // default variables
  iJumps = 0;
  iSuccessfulJumps = 0;
  iJumpsSinceAdapt = 0;
...
// Validate our MCMC
//**********************************************************************
void CIndependenceMetropolis::validate() {
  try {
...
// Build our MCMC
//**********************************************************************
void CIndependenceMetropolis::build() {
  try {
...
// Execute our MCMC
//**********************************************************************
void CIndependenceMetropolis::execute() {
  try {
...
//**********************************************************************
void CIndependenceMetropolis::generateRandomStart() {
  try {
...
//**********************************************************************
void CIndependenceMetropolis::generateNewCandidate() {
...
//**********************************************************************
void CIndependenceMetropolis::updateStepSize(int iIteration) {
...
//**********************************************************************
void CIndependenceMetropolis::buildCovarianceMatrix() {
  try {
...
//
//**********************************************************************
void CIndependenceMetropolis::fillMultivariateNormal(double stepsize) {
...
//
//**********************************************************************
void CIndependenceMetropolis::fillMultivariatet(double stepsize) {
...
//
//**********************************************************************
bool CIndependenceMetropolis::choleskyDecomposition() {
